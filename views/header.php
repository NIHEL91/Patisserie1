...
<header>
<nav class="navbar navbar-expand-lg  bg-dark justifi">
        <div class="container-fluid">
            <img src="../img/logoo.png" class="logo"/>

            <a class="navbar-brand text-white px-3" href="#">Accueil</a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                <a class="nav-link active text-white  px-3" aria-current="page" href="#">Anniversaires</a>
                </li>
                <li class="nav-item">
                <a class="nav-link text-white  px-3" href="#">Mariage</a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link text-white  px-3" href="#" >Contacter</a>
                </li>
            </ul>
            <form class="d-flex">
            <?php
                ...
                <a href="#"  class="btn  btn-sm me-2 "><img src="../img/panierimage.png" class="panier"/></a>
